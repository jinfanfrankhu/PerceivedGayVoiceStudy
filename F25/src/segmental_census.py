...
def main():
    ...
    # --- chart: median tokens/speaker per phone, min marked ---
    ...
    ax.set_title('Phone availability across 50 speakers\n'
    ...
    ax.legend(handles, KLASS_COLOR.keys(), fontsize=8, loc='lower right',
              title='manner')
    fig.tight_layout()
    fig.savefig(SEG_FIG / 'phone_census.png', dpi=120)
    plt.close(fig)
    ...
    print(f'  -> tables/phone_census.csv  + figures/segmental/phone_census.png')
